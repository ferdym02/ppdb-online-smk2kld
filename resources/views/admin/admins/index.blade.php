...
<main class="app-main">
  ...
  <div class="app-content">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-12">
          <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal" data-bs-target="#createAdminModal">Tambah Data</button>
          <div class="card">
            <div class="card-body">
      ...
      <div class="modal-content">
        <form action="/admin/admins" method="POST">
          ...
          <div class="modal-header">
            <h5 class="modal-title" id="createAdminModalLabel">Tambah Data Admin</h5>
        ...
        <form id="editForm" method="POST" action="{{ old('action_url', '') }}">
          ...
          <div class="modal-body">
            ...
            <div class="form-group mb-3">
              ...
              <input type="password" name="password_confirmation" id="editPasswordConfirmation" class="form-control @error('password_confirmation') is-invalid @enderror">
              @error('password_confirmation')
              <div class="invalid-feedback">{{ $message }}</div>
              @enderror
            </div>
